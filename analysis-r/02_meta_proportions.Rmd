...
knitr::kable(head(ssi_for_meta %>% dplyr::select(study_id, numerator, denominator, publication_year), 10))
```
...
knitr::kable(head(mortality_for_meta %>% dplyr::select(study_id, numerator, denominator), 10))
```
